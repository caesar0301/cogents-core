...
from cogents.core.base.routing.strategies.dynamic_complexity import DynamicComplexityStrategy
from cogents.core.base.routing.types import ModelTier, RoutingResult
...
class TestDynamicComplexityStrategy:
    ...
    def test_weight_normalization_warning(self, mock_llm_client):
        ...
        with patch("cogents.core.base.logging.get_logger") as mock_logger:
            strategy = DynamicComplexityStrategy(lite_client=mock_llm_client, config=config)
