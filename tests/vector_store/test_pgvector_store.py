...
from cogents_core.vector_store.pgvector import PGVectorStore
...
class TestPGVectorStoreUnit:
    ...
    def test_class_inherits_from_base(self):
        ...
        from cogents_core.vector_store import BaseVectorStore
    ...
    @patch("cogents_core.vector_store.pgvector.psycopg2")
